<x-screen-instructions :title="__('How to use Events')">
    <p>{{ __('The calendar every check-in, subscription, and report ultimately hangs off of. Anyone Manager+ can view it; only Admin+ can create, edit, or delete an event — cost is fixed once set.') }}</p>
